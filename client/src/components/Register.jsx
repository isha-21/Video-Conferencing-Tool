...
const Register = () => {
   ...
   axios.defaults.withCredentials = true;
    ...
    const onSub= async (e)=>{
        e.preventDefault();
       let val=  await axios.post("http://localhost:3000/register",user);
    ...
    useEffect(() => {
        const checkLogin= async ()=>{
         let val= await axios.get("http://localhost:3000/login");
    ...
    return (
        <>
       <div className="container" id="formm" color='green'>
       <div className="row">
